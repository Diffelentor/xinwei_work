...
<%--修改页面的小窗，被包含在manageexchangesData.jsp里，默认隐藏--%>
<div class="modal fade draggable-modal" id="exchanges_modify_div" tabindex="-1" role="basic" aria-hidden="true">

    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">外汇记录修改</h4>
            </div>
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="text" class="form-control" placeholder="请填写代号" id="exchanges_id" name="exchanges_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="请填写名称" id="exchanges_name" name="exchanges_name">
                                </div>
                            </div>
                            <div class="form-group">
