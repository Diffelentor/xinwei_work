...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!--页面开始=======================================================-->
            <!--设置页面ID-->
            <input type="hidden" id="page_id" name="page_id" value="user_statistic">
            <div class="row">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase font-green-haze"> 用户管理</span>
                                <span class="caption-helper">用户身份统计</span>
                            </div>
                            <div class="tools">
