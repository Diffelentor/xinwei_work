...
<%--添加页面的小窗，默认隐藏--%>
<div class="modal fade draggable-modal" id="history_ad_modify_div" tabindex="-1" role="basic" aria-hidden="true">
            ...
            <div class="portlet-body form">
                <form role="form">
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label has-success">
                            <input type="text" class="form-control edited" id="price_sale">
