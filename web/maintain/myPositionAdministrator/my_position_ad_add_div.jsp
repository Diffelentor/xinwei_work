...
<%--添加页面的小窗，默认隐藏--%>
<div class="modal fade draggable-modal" id="my_position_ad_add_div" tabindex="-1" role="basic" aria-hidden="true">
                ...
                <form role="form">
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label has-error">
                            <input type="text" class="form-control" readonly id="forward">
