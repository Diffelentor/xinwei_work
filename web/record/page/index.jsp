...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!--页面开始=======================================================-->
			<!--设置页面ID-->
			<input type="hidden" id="page_id" name="page_id" value="manage_todolist_data">
			<div class="row" id="record_query_setup">
				<div class="form-group">
					<label class="control-label col-sm-1" style="font-size: 18px">内容</label>
					<div class="col-md-2">
						<input id="content" type="text" class="form-control" value="" placeholder="请输入内容"/>
					</div>
					<div class="col-md-2">
