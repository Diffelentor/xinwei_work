...
<%--添加页面的小窗，被包含在manageexchangesData.jsp里，默认隐藏--%>
<div class="modal fade draggable-modal" id="exchanges_add_div" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">外汇记录增加</h4>
            </div>
