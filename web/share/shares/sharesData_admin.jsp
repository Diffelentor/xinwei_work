...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!--页面开始=======================================================-->
            <!--设置页面ID-->
            <input type="hidden" id="page_id" name="page_id" value="shares_data_admin">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-circle btn-lg green" id="table_print_button"
                            name="table_print_button">
                        <i class="fa fa-print"></i> 打印
                    </button>
                    <div style="float:right;">
                        <button type="button" style="float: right" class="btn default" id="refresh_button"
                                name="history_button">
                            <i class="fa fa-refresh"></i></button>
                        <button type="button" class="btn green" id="show_futures" name="show_futures">
                            <i class="fa fa-search"></i>期货
                        </button>
                        <button type="button" class="btn green" id="show_shares" name="show_shares">
                            <i class="fa fa-search"></i>股票
                        </button>
                        <button type="button" class="btn green" id="show_exchange" name="show_exchange">
                            <i class="fa fa-search"></i>外汇
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="datatable_tab">
                <div class="col-md-12 ">
                    <table class="table table-striped table-bordered table-hover datatable" id="record_list_admin">
                        <thead>
                        <tr>
...
<%@include file="../../share/shares/shares_add_div.jsp"%>
<%@include file="../../share/shares/shares_modify_div.jsp"%>
<%--本页专用的--%>
