...
var Page = function () {
    ...
    var initPageControl=function () {
        pageId = $("#page_id").val();
        if(pageId == "comment_statistic"){
            initCommentStatistics();
        }
    };
    ...
    var initCommentStatistics=function () {
        $.ajaxSettings.async = false;
        initCommentStatisticsRecord();
        $.ajaxSettings.async = true;
        initBarChart();
    }

    var initCommentStatisticsRecord=function () {
        var url = "../../news_file_servlet_action";
        var data = {"action":"get_comment_count_by_hour"};
