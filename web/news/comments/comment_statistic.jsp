...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!--页面开始=======================================================-->
            <!--设置页面ID-->
            <input type="hidden" id="page_id" name="page_id" value="comment_statistic">
            <div class="row">
                <div class="col-md-12">
                    <!-- BEGIN CHART PORTLET-->
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject bold uppercase font-green-haze">评论统计</span>
                                <span class="caption-helper">今日评论数统计</span>
                            </div>
...
<script src="comment_statistics.js"></script>
</body>
<!-- END BODY -->
</html>
